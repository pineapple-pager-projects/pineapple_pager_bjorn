...
A port/rewrite of [Bjorn](https://github.com/infinition/Bjorn) originally by infinition - the autonomous network reconnaissance Tamagotchi - for the WiFi Pineapple Pager. Now with theme management, hi-res graphics, and added functionality!
